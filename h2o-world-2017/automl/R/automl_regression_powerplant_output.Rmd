...
docker_data_path <- "/home/h2o/data/automl/data/powerplant_output.csv"
...
Lastly, let's split the data into two frames, a `train` (80%) and a `test` frame (20%).  The `test` frame will be used to score the leaderboard and to demonstrate how to generate preditions using an AutoML leader model.
```{r}
