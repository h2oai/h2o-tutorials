...
### Tuning
With some tuning, it is possible to reach to below 10% test set error rate in about one minute. Error rates of below 5% are possible with larger models.
```{r}
m3 <- h2o.deeplearning(
...
### More information can be found in the [H2O Deep Learning booklet](http://h2o.ai/resources) and in our [slides](http://www.slideshare.net/0xdata/presentations).
